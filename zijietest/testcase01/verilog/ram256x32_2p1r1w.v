...
module ram256x32_2p1r1w ( QB, ADRA, DA, WEA, MEA, CLKA, TEST1A, WMENA, ADRB, MEB, CLKB, TEST1B, RMB, RMEB);
...
wire ADRA_valid_rec;
assign ADRA_valid_rec = ( ( ADRA_pre < 256  )?1'b1:1'b0);

wire ADRB_valid;
assign ADRB_valid = ( ( ADRB_pre < 256 )?1'b1:1'b0);

wire ADRB_valid_rec;
assign ADRB_valid_rec = ( ( ADRB_pre < 256  )?1'b1:1'b0);
    ...
    begin
      ...
      if (is_adr_Valid(ADRAlatched) != `True ) begin
       ...
       begin
         ...
         $display("\n%m VIRL_MEM_WARNING:address ADRA is out of range, RANGE:0 to 255\n");
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            $display("      time=%t; instance=%m (ram256x32_2p1r1w_core)",$realtime);
          end
        end // WMENA != 4'b0010
  ...
  begin
    ...
    begin
      ...
      if (is_adr_Valid(ADRBlatched) != `True ) begin
       ...
       begin
         if( MES_ALL=="ON" && $realtime != 0 && mes_all_valid == 1'b1)
         $display("\n%m VIRL_MEM_WARNING:address ADRB is out of range, RANGE:0 to 255\n");
...
begin
  ...
  begin
    ...
    begin
      if( MES_ALL=="ON" && $realtime != 0 && mes_all_valid == 1'b1)
      begin
       $display("VIRL_MEM_WARNING: RMB = %b is not recommended value ; time = %t, instance = %m (ram256x32_2p1r1w_core)",RMB,$realtime);
      end
    end
  end
  else
  ...
  begin
    if( MES_ALL=="ON" && $realtime != 0 && mes_all_valid == 1'b1)
    begin
      $display("VIRL_MEM_WARNING: RMB = %b is not recommended value in Read Mode ; time = %t, instance = %m (ram256x32_2p1r1w_core)",RMB,$realtime);
    end // MES_ALL=="ON"
  end // RMB_set != 4'b0010
  end
