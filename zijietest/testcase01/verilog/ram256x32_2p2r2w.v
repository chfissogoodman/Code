...
module ram256x32_2p2r2w ( QA, QB, ADRA, DA, WEA, MEA, CLKA, TEST1A, RMEA, RMA, ADRB, DB, WEB, MEB, CLKB, TEST1B, RMEB, RMB);
...
input  [7:0] ADRA; // Address Input 
input  [31:0] DA; // Data Input 
input  [3:0] RMA; // Read Margin Input 
input  [7:0] ADRB; // Address Input 
...
`endif
wire ADRA_valid;
//assign ADRA_valid =  (ADRA_buf >= 8'b00000000 && ADRA_buf <= 8'b11111111 )?1'b1:1'b0;
assign ADRA_valid =  (ADRA_buf <= 8'b11111111 )?1'b1:1'b0;
wire ADRB_valid;
//assign ADRB_valid =  (ADRB_buf >= 8'b00000000 && ADRB_buf <= 8'b11111111 )?1'b1:1'b0;
...
`ifdef VIRAGE_FAST_VERILOG
module generic_behav_ram256x32_2p2r2w (  QA, QB, ADRA, DA, WEA, MEA, CLKA, TEST1A, RMEA, RMA, ADRB, DB, WEB, MEB, CLKB, TEST1B, RMEB, RMB,sim_check_A, sim_check_B );
`else
module generic_behav_ram256x32_2p2r2w (  QA, QB, ADRA, DA, WEA, MEA, CLKA, TEST1A, RMEA, RMA, ADRB, DB, WEB, MEB, CLKB, TEST1B, RMEB, RMB, EVENT_TCQ_A, EVENT_TCQ_B,notif_adra, notif_da, notif_wea, notif_mea, notif_clka, notif_clka_CLKB_rise_rise_rec, notif_test1a, notif_rmea, notif_rma, notif_adrb, notif_db, notif_web, notif_meb, notif_clkb, notif_clkb_CLKA_rise_rise_rec, notif_test1b, notif_rmeb, notif_rmb );
`endif // endif of VIRAGE_FAST_VERILOG

parameter PreloadFilename = "init.file";
parameter MES_ALL = "ON";
parameter words = 256, bits = 32, addrbits = 8, O_delay=0.0, timingmode = 1, rmbits=4;
...
reg[ 31:0] mem_core_array_read [0:255];
...
begin : blk_intposclock_1
  ...
  else if((ADRBlatched > 8'b11111111) && (MEBlatched === 1'b1) && (WEBlatched === 1'b1) )
  begin
    $display("\n%m VIRL_MEM_WARNING:address is out of range\n RANGE: 0 to 255\n");
