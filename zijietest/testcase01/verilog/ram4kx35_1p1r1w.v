...
//                                                                    
//   Memory Name:ram4kx35_1p1r1w                                      
//   Memory Size:4096 words x 35 bits                                 
//                                                                    
//                               PORT NAME                            
//                               ---------                            
//               Output Ports                                         
...
module ram4kx35_1p1r1w ( Q, ADR, D, WE, ME, CLK, TEST1, RME, RM);
...
input  [34:0] D; // Data Input 
input  [3:0] RM; // Read Margin Input 
output  [34:0] Q; // Data Output Bus
...
`ifdef VIRAGE_FAST_VERILOG
module generic_behav_ram4kx35_1p1r1w (  Q, ADR, D, WE, ME, CLK, TEST1, RME, RM );
`else
module generic_behav_ram4kx35_1p1r1w (  Q, ADR, D, WE, ME, CLK, TEST1, RME, RM,notif_adr, notif_d, notif_we, notif_me, notif_clk, notif_test1, notif_rme, notif_rm );
`endif // endif of VIRAGE_FAST_VERILOG

parameter PreloadFilename = "init.file";
parameter MES_ALL = "ON";
parameter words = 4096, bits = 35, addrbits = 12, O_delay=0.0, timingmode = 1, rmbits=4;
...
real CLKA_T;
wire   [34:0]  Q_temp;
reg    [34:0]  Q_local_tmp;
reg mes_all_valid;
integer i;
reg  [bits-1:0] mem_core_array [0:words -1];
reg[ 34:0] mem_core_array_read [0:4095];
...
begin
  ...
  begin
    mem_core_array[Adr_to_corrupt] = 35'bx;
...
begin
  ...
  begin
    ...
    begin
      mem_core_array[row_index] = 35'bx;
