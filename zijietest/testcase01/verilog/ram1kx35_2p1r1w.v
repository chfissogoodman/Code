...
//                                                                    
//   Memory Name:ram1kx35_2p1r1w                                      
//   Memory Size:1024 words x 35 bits                                 
//                                                                    
//                               PORT NAME                            
//                               ---------                            
//               Output Ports                                         
...
module ram1kx35_2p1r1w ( QB, ADRA, DA, WEA, MEA, CLKA, TEST1A, WMENA, ADRB, MEB, CLKB, TEST1B, RMB, RMEB);
...
// Timing Checks
  ...
  $setuphold (posedge CLKA  &&& ENDA, posedge DA[32], Tdc, Tcdx, notif_da );
  $setuphold (posedge CLKA  &&& ENDA, negedge DA[32], Tdc, Tcdx, notif_da );
  $setuphold (posedge CLKA  &&& ENDA, posedge DA[33], Tdc, Tcdx, notif_da );
  $setuphold (posedge CLKA  &&& ENDA, negedge DA[33], Tdc, Tcdx, notif_da );
  $setuphold (posedge CLKA  &&& ENDA, posedge DA[34], Tdc, Tcdx, notif_da );
  $setuphold (posedge CLKA  &&& ENDA, negedge DA[34], Tdc, Tcdx, notif_da );
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            $display("      time=%t; instance=%m (ram1kx35_2p1r1w_core)",$realtime);
          end
        end // WMENA != 4'b0010
...
begin
  ...
  begin
    ...
    begin
      if( MES_ALL=="ON" && $realtime != 0 && mes_all_valid == 1'b1)
      begin
       $display("VIRL_MEM_WARNING: RMB = %b is not recommended value ; time = %t, instance = %m (ram1kx35_2p1r1w_core)",RMB,$realtime);
      end
    end
  end
  else
  ...
  begin
    if( MES_ALL=="ON" && $realtime != 0 && mes_all_valid == 1'b1)
    begin
      $display("VIRL_MEM_WARNING: RMB = %b is not recommended value in Read Mode ; time = %t, instance = %m (ram1kx35_2p1r1w_core)",RMB,$realtime);
    end // MES_ALL=="ON"
  end // RMB_set != 4'b0010
  end
