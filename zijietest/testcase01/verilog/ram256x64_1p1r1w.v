...
module ram256x64_1p1r1w ( Q, ADR, D, WE, ME, CLK, TEST1, RME, RM);
...
input  [7:0] ADR; // Address Input 
input  [63:0] D; // Data Input 
input  [3:0] RM; // Read Margin Input 
output  [63:0] Q; // Data Output Bus
...
assign  D_buf[32] =  D[32];
assign  D_buf[33] =  D[33];
assign  D_buf[34] =  D[34];
assign  D_buf[35] =  D[35];
assign  D_buf[36] =  D[36];
assign  D_buf[37] =  D[37];
assign  D_buf[38] =  D[38];
assign  D_buf[39] =  D[39];
assign  D_buf[40] =  D[40];
assign  D_buf[41] =  D[41];
assign  D_buf[42] =  D[42];
assign  D_buf[43] =  D[43];
assign  D_buf[44] =  D[44];
assign  D_buf[45] =  D[45];
assign  D_buf[46] =  D[46];
assign  D_buf[47] =  D[47];
assign  D_buf[48] =  D[48];
assign  D_buf[49] =  D[49];
assign  D_buf[50] =  D[50];
assign  D_buf[51] =  D[51];
assign  D_buf[52] =  D[52];
assign  D_buf[53] =  D[53];
assign  D_buf[54] =  D[54];
assign  D_buf[55] =  D[55];
assign  D_buf[56] =  D[56];
assign  D_buf[57] =  D[57];
assign  D_buf[58] =  D[58];
assign  D_buf[59] =  D[59];
assign  D_buf[60] =  D[60];
assign  D_buf[61] =  D[61];
assign  D_buf[62] =  D[62];
assign  D_buf[63] =  D[63];
wire WE_buf;
assign  WE_buf =  WE;
wire ME_buf;
assign  ME_buf =  ME;
...
`endif
wire ADR_valid;
//assign ADR_valid =  (ADR_buf >= 8'b00000000 && ADR_buf <= 8'b11111111 )?1'b1:1'b0;
...
// Timing Checks
  ...
  $setuphold (posedge CLK  &&& END, posedge D[32], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[32], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[33], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[33], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[34], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[34], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[35], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[35], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[36], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[36], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[37], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[37], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[38], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[38], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[39], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[39], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[40], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[40], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[41], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[41], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[42], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[42], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[43], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[43], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[44], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[44], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[45], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[45], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[46], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[46], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[47], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[47], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[48], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[48], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[49], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[49], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[50], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[50], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[51], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[51], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[52], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[52], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[53], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[53], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[54], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[54], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[55], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[55], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[56], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[56], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[57], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[57], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[58], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[58], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[59], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[59], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[60], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[60], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[61], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[61], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[62], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[62], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, posedge D[63], Tdc, Tcdx, notif_d );
  $setuphold (posedge CLK  &&& END, negedge D[63], Tdc, Tcdx, notif_d );
...
`ifdef VIRAGE_FAST_VERILOG
generic_behav_ram256x64_1p1r1w #( PreloadFilename, MES_ALL) u0 (  .Q (Q_buf), .ADR (ADR_buf), .D (D_buf), .WE(WE_buf), .ME(ME_buf), .CLK(CLK_buf), .TEST1(TEST1_buf), .RME(RME_buf), .RM (RM_int) );
`else
generic_behav_ram256x64_1p1r1w #( PreloadFilename, MES_ALL) u0 (  .Q (Q_buf), .ADR (ADR_buf), .D (D_buf), .WE(WE_buf), .ME(ME_buf), .CLK(CLK_buf), .TEST1(TEST1_buf), .RME(RME_buf), .RM (RM_int),.notif_adr(notif_adr), .notif_d(notif_d), .notif_we(notif_we), .notif_me(notif_me), .notif_clk(notif_clk), .notif_test1(notif_test1), .notif_rme(notif_rme), .notif_rm(notif_rm) );
`endif // endif of VIRAGE_FAST_VERILOG
...
`ifdef VIRAGE_FAST_VERILOG
module generic_behav_ram256x64_1p1r1w (  Q, ADR, D, WE, ME, CLK, TEST1, RME, RM );
`else
module generic_behav_ram256x64_1p1r1w (  Q, ADR, D, WE, ME, CLK, TEST1, RME, RM,notif_adr, notif_d, notif_we, notif_me, notif_clk, notif_test1, notif_rme, notif_rm );
`endif // endif of VIRAGE_FAST_VERILOG

parameter PreloadFilename = "init.file";
parameter MES_ALL = "ON";
parameter words = 256, bits = 64, addrbits = 8, O_delay=0.0, timingmode = 1, rmbits=4;
...
`ifdef VIRAGE_FAST_VERILOG
`else
input notif_adr, notif_d, notif_we, notif_me, notif_clk, notif_test1, notif_rme, notif_rm;
